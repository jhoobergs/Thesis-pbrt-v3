...
namespace pbrt {
    ...
    BSPNodeBased::BSPNodeBased(std::vector<std::shared_ptr<pbrt::Primitive>> p, uint32_t isectCost,
    ...
    void BSPNodeBased::buildTree() {
        ...
        while (!stack.empty()) { // || nodeNum > 235000 || nodeNum > 1400000
            ...
            std::vector<Vector3f> nodeDirections = calculateDirections(gen, K, primitives, currentBuildNode.primNums,
